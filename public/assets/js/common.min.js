let cmn={},ssd={post:[]},IS_HISTORY_API=(cmn.saveFormData=t=>{var e=document.querySelector(t);if(e){e=new FormData(e);let s={};e.forEach((t,e)=>{s[e]=t}),sessionStorage.setItem(t,JSON.stringify(s))}},cmn.loadFormData=t=>{let o=document.querySelector(t);if(o){t=sessionStorage.getItem(t);if(t){let s=JSON.parse(t);Object.keys(s).forEach(e=>{var t=o.querySelector(`[name="${e}"]`);t&&("checkbox"===t.type||"radio"===t.type?o.querySelectorAll(`[name="${e}"]`).forEach(t=>{t.checked=t.value===s[e]}):"SELECT"===t.tagName&&Array.isArray(s[e])?Array.from(t.options).forEach(t=>{t.selected=s[e].includes(t.value)}):t.value=s[e])})}}},cmn.getAgeAtThatTime=(t,e="1975-07-09")=>{let s=t,o=e,a={},n=new Date,i=n.getFullYear(),l=n.getMonth()+1,c=n.getDate(),r;return s=s.replace(/-/g,""),o=o.replace(/-/g,""),l<10&&(l="0"+l),c<10&&(c="0"+c),r=i+""+l+c,0<s-o&&(a.age=Math.floor((s-o)/1e4),a.is_same=Math.floor((r-o)/1e4)===a.age),a},cmn.getDir=t=>{let e=t.split("/").filter(Boolean),s={};return 0===e.length?s.level1="home":e.forEach((t,e)=>{s["level"+(e+1)]=t}),s},cmn.getNrToBr=(t="")=>t=(t=(t=t.replace(/\r\n/g,"<br>")).replace(/\r/g,"<br>")).replace(/\n/g,"<br>"),cmn.getParam=t=>{let e=t||location.href,s=[],o={},a;for(a in e=1<e.split("?").length?e.split("?")[1]:e,s=e.split("&")){var n=s[a].split("=");2==n.length&&""!=n[1].trim()&&(o[n[0]]=n[1])}return o},history&&history.pushState&&void 0!==history.state),IS_HISTORY_PUSH=!1,CURRENT_TIME=(cmn.historyPushState=(t,e,s)=>{IS_HISTORY_API&&(history.pushState(t,e,s),IS_HISTORY_PUSH=!0)},cmn.historySet=e=>{IS_HISTORY_API&&$(window).on("popstate",function(t){t=t.originalEvent?.state||null;e&&e(t)})},$(document).on("mouseenter","a, button",function(){$(this).addClass("hover")}),$(document).on("mouseleave","a, button",function(){$(this).removeClass("hover")}),cmn.loadHtml=async(t="")=>{if(""===t.trim())return{status:"fail",message:"ファイル名が指定されていません"};try{var e=await fetch(t,{method:"GET",headers:{"X-CSRF-Token":CSRF_TOKEN}});if(e.ok)return await e.text();throw new Error("HTTPエラー: "+e.status)}catch(t){return""}},cmn.loadJson=async(t="")=>{if(""===t.trim())return{status:"fail",message:"ファイル名が指定されていません"};try{var e=await fetch("/api/index.php",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-Token":CSRF_TOKEN},body:JSON.stringify({filename:t})});if(e.ok)return await e.json();throw new Error("HTTPエラー: "+e.status)}catch(t){return{status:"fail",message:t.message||"不明なエラーが発生しました"}}},cmn.pageScroll=(t=1,e=300,s)=>($("html, body").stop(),$("html").animate({scrollTop:t},e),$("body").animate({scrollTop:t},e,function(){s&&s()}),!1),(new Date).getTime()),scroll=(cmn.removeSplash=()=>{var t=1500-Math.min((new Date).getTime()-CURRENT_TIME,1500);setTimeout(()=>{$(".js-splash").remove()},t)},cmn.replaceTag=(t="")=>t.replace(/<[^>]*>/g,""),cmn.replaceUTF=(t="")=>t.replace(/u([\da-fA-F]{4})/g,"&#x$1;"),{}),IS_LOCALSTORAGE=(scroll.is_touch=!!("ontouchstart"in window&&"ontouchend"in window||navigator.msPointerEnabled||0<navigator.maxTouchPoints),scroll.eventstart=scroll.is_touch?"touchstart":"mousedown",scroll.eventmove=scroll.is_touch?"touchmove":"mousemove",scroll.eventend=scroll.is_touch?"touchend":"mouseup",scroll.isNumber=(t="")=>/^[0-9]+$/.test(t),(()=>{let t=new $.Event("resizestop"),e;$(window).on("resize",()=>{e&&clearTimeout(e),e=setTimeout(function(){$(window).trigger(t)},300)})})(),scroll.show=(s=".scroll",o={})=>{let a=$(s),t=$(".scroll__outer",a),n=$(".scroll__inner",a),i=$(".scroll__content",a),e=$(".scroll__bar",a);if(scroll.is_touch)return t.width("").height(""),!1;if(0===a.length||0===t.length||0===n.length||0===i.length)return!1;let l=o.direction||"horizontal",c="horizontal"===l,r="horizontal"===l?"left":"top",m="horizontal"===l?"width":"height",p="horizontal"===l?"height":"width",h="horizontal"===l?"margin-top":"margin-left",d="";o.bg&&(d+=s+" .scroll__bar::after{background:"+o.bg+"}",delete o.bg),o.color&&(d+=s+" .scroll__bar span::after{background:"+o.color+"}",delete o.color),o.size&&scroll.isNumber(o.size)&&(d+=s+" .scroll__bar span::after{"+p+":"+Math.min(o.size,20)+"px;"+h+": "+Math.min(o.size,20)/2*-1+"px}",delete o.size),o.bg_size&&scroll.isNumber(o.size)&&(d+=s+" .scroll__bar::after{"+p+":"+Math.min(o.bg_size,20)+"px;"+h+": "+Math.min(o.bg_size,20)/2*-1+"px}",delete o.bg_size),""!=d&&$("head").append("<style>"+d+"</style>"),n.css({overflow:"hidden"});var u=i[0].scrollWidth,g=i[0].scrollHeight;let _=c?a.width():a.height(),f=c?u:g;if(!(1<=Math.abs(_-f)&&1<f-_))return 0<e.length&&e.hide(),!1;e.show(),n.css({overflow:"auto"});let v=!1,w=0,b=0,S=0,y,T=0,j=0,P=0,I=!1;_-=o.padding||0;n.on("scroll",()=>{if(v)return!1;var t=c?i.position().left:i.position().top;let e=Math.ceil(Math.abs(t)/f*100);100<e+j&&(e=100-j),k.css(r,e+"%")}),$(window).on("resize",()=>{I=!0}),$(window).on("resizestop",()=>{var t=$(".scroll__bar-control",a),e=c?t.width():t.height();y=c?window.innerWidth:window.innerHeight,S!=y&&(scroll.show(s,o),0<t.length&&(T=_-e),I=!1,S=y)}),0===e.length&&(a.append(`
      <div class="scroll__bar scroll__bar--${l}">
        <span class="scroll__bar-control"></span>
      </div>
    `),e=$(".scroll__bar",a),o.padding)&&e.css(m,"calc(100% - "+o.padding+"px)").css(r,o.padding/2+"px");let k=$(".scroll__bar-control",a);c?(t.height(g),n.height(g+30)):(t.width(u),n.width(u+30)),j=Math.ceil(_/f*100),P=c?(k.width(j+"%"),k.width()):(k.height(j+"%"),k.height()),T||(T=_-P,(()=>{let e;k.on(scroll.eventstart,function(t){v=!0,e=c?i.position().left:i.position().top,w=c?t.pageX:t.pageY,b=Math.floor(Math.abs(e)/f*_)}),$(document).on(scroll.eventmove,function(s){if(v&&!I){s=(c?s.pageX:s.pageY)-w,s=b+s;let t=0,e;s=Math.max(0,s),s=Math.min(Math.ceil(T),s),t=Math.ceil(s/_*100),e=f*(t/100),100<t+j&&(t=100-j),k.css(r,t+"%"),c?n.scrollLeft(e):n.scrollTop(e)}}),$(document).on(scroll.eventend,function(){v=!1})})())},cmn.shuffleArray=(t=[])=>{let e,s;for(e=t.length;1<e;e--)s=Math.floor(Math.random()*e),[t[s],t[e-1]]=[t[e-1],t[s]];return t},cmn.sticky=(t="",e,s)=>{let o=document.querySelector(t);if(""===t.trim()||!o||"function"!=typeof e||"function"!=typeof s)return!1;let a=o.getBoundingClientRect().top;window.addEventListener("scroll",()=>{var t=o.getBoundingClientRect().top;t===a?e():a,a=t})},"localStorage"in window&&null!==window.localStorage),IS_SESSIONSTORAGE="sessionStorage"in window&&null!==window.sessionStorage;cmn.storageLS=(e,t)=>{let s=null;if(IS_LOCALSTORAGE&&void 0!==e)if(void 0!==t)localStorage[e]="object"==typeof t?JSON.stringify(t):t;else try{s=new Function("return "+localStorage[e])()}catch(t){s=localStorage[e]}return s},cmn.storageDelLS=t=>{localStorage.removeItem(t)},cmn.storageSS=(e,t)=>{let s=null;if(IS_SESSIONSTORAGE&&void 0!==e)if(void 0!==t)sessionStorage[e]="object"==typeof t?JSON.stringify(t):t;else try{s=new Function("return "+sessionStorage[e])()}catch(t){s=sessionStorage[e]}return s},cmn.storageDelSS=t=>{sessionStorage.removeItem(t)},$(()=>{let r=!1;$(document).on("click",".js-comment-submit",async function(){let t=$(this),e=t.closest(".js-form-comment"),s=$('[name="comment"]',e),o=$('[name="author"]',e),a=$(".js-comment-notification",e),n=$(".js-comment-inner"),i=$(".js-comment-list");$('[name="comment_post_ID"]',e).val();var l=new FormData(e[0]),l=Object.fromEntries(l.entries());if(s.on("input",()=>{a.removeClass("caution").hide()}),!r){if(""===s.val().trim())return a.addClass("caution").html("コメントが入力されていることをご確認の上、もう一度お試しください。").show(),!1;r=!0,t.html('<span class="animation-blinker">送信中...</span>');var c,l=await(await fetch("/assets/ajax/post-comment.php",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-Token":CSRF_TOKEN},body:JSON.stringify(l)})).text();"success"===l?(a.removeClass("caution").html("コメントありがとうございます！").show(),c=`
        ...
        `,0===i.length&&(n.append('<div class="post-comment__list js-comment-list"></div>'),i=$(".js-comment-list")),0<$(".post-comment__unit",i).length?$(".post-comment__unit:first-child",i).before(c):i.append(c),s.val(""),o.val(""),console.log(ssd.post)):(console.log(l),a.addClass("caution").html("コメント送信できませんでした。恐れ入りますが、もう一度お試しください。").show()),r=!1,t.html("コメントする")}return!1})}),ssd.changePage=async(h={},d)=>{let u=$(".js-article"),g=$(".js-article-inner"),_=$(".js-loading");u.css({"min-height":u.height()}),u.animate({top:-10,opacity:0},350,async function(){_.show(),h.path||(h.path="404");var t="https://simplesimples.com"+h.path,e=h.path.replace(/^\/|\/$/g,"").split("/"),s={};let o="シンプルシンプルデザイン",a="",n="",i,l,c="",r=!1,m=!1;switch(e[0]){case"":o="",a="",l=await fetch("/assets/include/pages/home.php"),c=await l.text();break;case"blog":o="個人ブログは引っ越しました | "+o,a="個人ブログは別ドメインに引っ越ししました。ぜひ、引っ越し先をご覧ください。",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"service":o="サービス | "+o,a="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"about":o="事業内容 | "+o,a="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"contact":o="お問い合わせ | "+o,a="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"privacy":o="プライバシーポリシー | "+o,a="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"post":o="制作ブログ | "+o,a="",n="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text();break;case"search":var p=cmn.getParam(location.search).q;if(!p)return void ssd.changePage();p=decodeURIComponent(p),o=`制作ブログ「${p}」の検索結果 | `+o;a=`制作ブログ内で「${p}」を含む記事は、10件見つかりました。`,n="",c=e[0];break;case"web":case"video":case"overview":let t="";"web"===e[0]&&e[3]?t=e[3]:"web"!=e[0]&&e[2]&&(t=e[2]),t?(m=!0,t=decodeURIComponent(t),(post_list=ssd.getPostListInfo(t))&&(o=post_list.title,a=post_list.description,n=post_list.img,c=await ssd.getPostData(post_list.id))&&""!=c?i={id:post_list.id,html:c}:r=!0):(o="",a="",n="",l=await fetch(`/assets/include/pages/${e[0]}.php`),c=await l.text());break;default:r=!0}r&&(o="表示できませんでした | "+o,a="",l=await fetch("/assets/include/pages/system.php"),c=await l.text()),$("title").html(o),$('meta[name="description"]').attr("content",a),$('meta[property="og:image"]').attr("content",n),$('link[rel="canonical"]').attr("href",t),_.hide(),g.html(c),u.css({"min-height":"unset"}),$(window).scrollTop(0),u.animate({top:0,opacity:1},350),m&&hljs.highlightAll(),d&&h.path!=ssd.last_history&&(ssd.last_history=h.path,s.path=h.path,i&&(s.data=i),cmn.historyPushState(s,"",h.path))})},ssd.getPostData=async e=>{let t=ssd.post.find(t=>t.id==e);if(!t){if(!(t=await ssd.loadPost(e))?.content)return"TODO ネット切れてる場合";ssd.post.push(t)}var s=t?.image?`<figure class="post__mainvisual" style="background-image: url(${t.image});"></figure>`:"";let o=t?.acf?.update||"";o&&(n=o.split("-"),o=`(${n[0]}年${n[1]}月${n[2]}日更新)`);var a,n=encodeURIComponent("https://simplesimples.com"+t.link),i=encodeURIComponent(t.title),l=encodeURIComponent("【シンプルシンプルデザイン】"),l=`
<ul class="sns-list post__sns-list">
  ${t?.acf?.github?`<li><a class="sns-github" href="${t.acf.github}"><span class="icon-github"></span></a></li>`:""}
  <li><a href="${`https://x.com/share?url=${n}&text=`+i+l}"><span class="icon-twitter"></span></a></li>
  <li><a href="${"https://www.facebook.com/sharer/sharer.php?u="+n}"><span class="icon-facebook"></span></a></li>
  <li><a href="${`https://line.me/R/msg/text/?${l}${i} `+n}"><span class="icon-line"></span></a></li>
</ul>
  `,i=0===t.comments.length?'<p class="post-comment__none js-comment-none">この記事の最初のコメントを書いてくれると嬉しいです！</p>':"";let c="";for(a of t.comments){let{author:t,content:e,date:s}=a;t=t.trim()||"(匿名)",e=(e=e.replace(/</g,"＜").replace(/>/g,"＞")).replace(/&lt;/g,"＜").replace(/&gt;/g,"＞"),e=cmn.getNrToBr(e),c+=`
<div class="post-comment__unit">
  <div class="post-comment__unit-inner">
    ${e}
    <div class="post-comment__unit-info">
