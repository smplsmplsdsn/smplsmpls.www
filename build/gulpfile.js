...
gulp.task('css.concat', () => {
  return gulp.src(['src/sass/var.scss', 'src/sass/setting/**/*.scss', 'src/sass/base/**/*.scss', 'src/sass/common/**/*.scss', 'src/sass/individual/**/*.scss'])
...
// JSファイルを結合する
gulp.task('js.concat', () => {
  return gulp.src(['src/js/first.js', 'src/js/common/**/*.js', 'src/js/individual/**/*.js', 'src/js/last.js'])
