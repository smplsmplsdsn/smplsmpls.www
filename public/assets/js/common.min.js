let cmn={},ssd={post:[]},IS_HISTORY_API=(cmn.saveFormData=t=>{var s=document.querySelector(t);if(s){s=new FormData(s);let e={};s.forEach((t,s)=>{e[s]=t}),sessionStorage.setItem(t,JSON.stringify(e))}},cmn.loadFormData=t=>{let o=document.querySelector(t);if(o){t=sessionStorage.getItem(t);if(t){let e=JSON.parse(t);Object.keys(e).forEach(s=>{var t=o.querySelector(`[name="${s}"]`);t&&("checkbox"===t.type||"radio"===t.type?o.querySelectorAll(`[name="${s}"]`).forEach(t=>{t.checked=t.value===e[s]}):"SELECT"===t.tagName&&Array.isArray(e[s])?Array.from(t.options).forEach(t=>{t.selected=e[s].includes(t.value)}):t.value=e[s])})}}},cmn.getAgeAtThatTime=(t,s="1975-07-09")=>{let e=t,o=s,a={},n=new Date,i=n.getFullYear(),l=n.getMonth()+1,r=n.getDate(),c;return e=e.replace(/-/g,""),o=o.replace(/-/g,""),l<10&&(l="0"+l),r<10&&(r="0"+r),c=i+""+l+r,0<e-o&&(a.age=Math.floor((e-o)/1e4),a.is_same=Math.floor((c-o)/1e4)===a.age),a},cmn.getDir=t=>{let s=t.split("/").filter(Boolean),e={};return 0===s.length?e.level1="home":s.forEach((t,s)=>{e["level"+(s+1)]=t}),e},cmn.getNrToBr=(t="")=>t=(t=(t=t.replace(/\r\n/g,"<br>")).replace(/\r/g,"<br>")).replace(/\n/g,"<br>"),cmn.getParam=t=>{let s=t||location.href,e=[],o={},a;for(a in s=1<s.split("?").length?s.split("?")[1]:s,e=s.split("&")){var n=e[a].split("=");2==n.length&&""!=n[1].trim()&&(o[n[0]]=n[1])}return o},history&&history.pushState&&void 0!==history.state),IS_HISTORY_PUSH=!1,CURRENT_TIME=(cmn.historyPushState=(t,s,e)=>{IS_HISTORY_API&&(history.pushState(t,s,e),IS_HISTORY_PUSH=!0)},cmn.historySet=s=>{IS_HISTORY_API&&$(window).on("popstate",function(t){t=t.originalEvent?.state||null;s&&s(t)})},$(document).on("mouseenter","a, button",function(){$(this).addClass("hover")}),$(document).on("mouseleave","a, button",function(){$(this).removeClass("hover")}),cmn.loadHtml=async(t="")=>{if(""===t.trim())return{status:"fail",message:"ファイル名が指定されていません"};try{var s=await fetch(t,{method:"GET",headers:{"X-CSRF-Token":CSRF_TOKEN}});if(s.ok)return await s.text();throw new Error("HTTPエラー: "+s.status)}catch(t){return""}},cmn.loadJson=async(t="")=>{if(""===t.trim())return{status:"fail",message:"ファイル名が指定されていません"};try{var s=await fetch("/api/index.php",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-Token":CSRF_TOKEN},body:JSON.stringify({filename:t})});if(s.ok)return await s.json();throw new Error("HTTPエラー: "+s.status)}catch(t){return{status:"fail",message:t.message||"不明なエラーが発生しました"}}},cmn.pageScroll=(t=1,s=300,e)=>($("html, body").stop(),$("html").animate({scrollTop:t},s),$("body").animate({scrollTop:t},s,function(){e&&e()}),!1),(new Date).getTime()),scroll=(cmn.removeSplash=()=>{var t=1500-Math.min((new Date).getTime()-CURRENT_TIME,1500);setTimeout(()=>{$(".js-splash").remove()},t)},cmn.replaceTag=(t="")=>t.replace(/<[^>]*>/g,""),cmn.replaceUTF=(t="")=>t.replace(/u([\da-fA-F]{4})/g,"&#x$1;"),{}),IS_LOCALSTORAGE=(scroll.is_touch=!!("ontouchstart"in window&&"ontouchend"in window||navigator.msPointerEnabled||0<navigator.maxTouchPoints),scroll.eventstart=scroll.is_touch?"touchstart":"mousedown",scroll.eventmove=scroll.is_touch?"touchmove":"mousemove",scroll.eventend=scroll.is_touch?"touchend":"mouseup",scroll.isNumber=(t="")=>/^[0-9]+$/.test(t),(()=>{let t=new $.Event("resizestop"),s;$(window).on("resize",()=>{s&&clearTimeout(s),s=setTimeout(function(){$(window).trigger(t)},300)})})(),scroll.show=(e=".scroll",o={})=>{let a=$(e),t=$(".scroll__outer",a),n=$(".scroll__inner",a),i=$(".scroll__content",a),s=$(".scroll__bar",a);if(scroll.is_touch)return t.width("").height(""),!1;if(0===a.length||0===t.length||0===n.length||0===i.length)return!1;let l=o.direction||"horizontal",r="horizontal"===l,c="horizontal"===l?"left":"top",m="horizontal"===l?"width":"height",p="horizontal"===l?"height":"width",d="horizontal"===l?"margin-top":"margin-left",h="";o.bg&&(h+=e+" .scroll__bar::after{background:"+o.bg+"}",delete o.bg),o.color&&(h+=e+" .scroll__bar span::after{background:"+o.color+"}",delete o.color),o.size&&scroll.isNumber(o.size)&&(h+=e+" .scroll__bar span::after{"+p+":"+Math.min(o.size,20)+"px;"+d+": "+Math.min(o.size,20)/2*-1+"px}",delete o.size),o.bg_size&&scroll.isNumber(o.size)&&(h+=e+" .scroll__bar::after{"+p+":"+Math.min(o.bg_size,20)+"px;"+d+": "+Math.min(o.bg_size,20)/2*-1+"px}",delete o.bg_size),""!=h&&$("head").append("<style>"+h+"</style>"),n.css({overflow:"hidden"});var u=i[0].scrollWidth,g=i[0].scrollHeight;let _=r?a.width():a.height(),f=r?u:g;if(!(1<=Math.abs(_-f)&&1<f-_))return 0<s.length&&s.hide(),!1;s.show(),n.css({overflow:"auto"});let b=!1,v=0,w=0,y=0,S,j=0,T=0,k=0,P=!1;_-=o.padding||0;n.on("scroll",()=>{if(b)return!1;var t=r?i.position().left:i.position().top;let s=Math.ceil(Math.abs(t)/f*100);100<s+T&&(s=100-T),C.css(c,s+"%")}),$(window).on("resize",()=>{P=!0}),$(window).on("resizestop",()=>{var t=$(".scroll__bar-control",a),s=r?t.width():t.height();S=r?window.innerWidth:window.innerHeight,y!=S&&(scroll.show(e,o),0<t.length&&(j=_-s),P=!1,y=S)}),0===s.length&&(a.append(`
      <div class="scroll__bar scroll__bar--${l}">
        <span class="scroll__bar-control"></span>
      </div>
    `),s=$(".scroll__bar",a),o.padding)&&s.css(m,"calc(100% - "+o.padding+"px)").css(c,o.padding/2+"px");let C=$(".scroll__bar-control",a);r?(t.height(g),n.height(g+30)):(t.width(u),n.width(u+30)),T=Math.ceil(_/f*100),k=r?(C.width(T+"%"),C.width()):(C.height(T+"%"),C.height()),j||(j=_-k,(()=>{let s;C.on(scroll.eventstart,function(t){b=!0,s=r?i.position().left:i.position().top,v=r?t.pageX:t.pageY,w=Math.floor(Math.abs(s)/f*_)}),$(document).on(scroll.eventmove,function(e){if(b&&!P){e=(r?e.pageX:e.pageY)-v,e=w+e;let t=0,s;e=Math.max(0,e),e=Math.min(Math.ceil(j),e),t=Math.ceil(e/_*100),s=f*(t/100),100<t+T&&(t=100-T),C.css(c,t+"%"),r?n.scrollLeft(s):n.scrollTop(s)}}),$(document).on(scroll.eventend,function(){b=!1})})())},cmn.shuffleArray=(t=[])=>{let s,e;for(s=t.length;1<s;s--)e=Math.floor(Math.random()*s),[t[e],t[s-1]]=[t[s-1],t[e]];return t},cmn.sticky=(t="",s,e)=>{let o=document.querySelector(t);if(""===t.trim()||!o||"function"!=typeof s||"function"!=typeof e)return!1;let a=o.getBoundingClientRect().top;window.addEventListener("scroll",()=>{var t=o.getBoundingClientRect().top;t===a?s():a,a=t})},"localStorage"in window&&null!==window.localStorage),IS_SESSIONSTORAGE="sessionStorage"in window&&null!==window.sessionStorage;cmn.storageLS=(s,t)=>{let e=null;if(IS_LOCALSTORAGE&&void 0!==s)if(void 0!==t)localStorage[s]="object"==typeof t?JSON.stringify(t):t;else try{e=new Function("return "+localStorage[s])()}catch(t){e=localStorage[s]}return e},cmn.storageDelLS=t=>{localStorage.removeItem(t)},cmn.storageSS=(s,t)=>{let e=null;if(IS_SESSIONSTORAGE&&void 0!==s)if(void 0!==t)sessionStorage[s]="object"==typeof t?JSON.stringify(t):t;else try{e=new Function("return "+sessionStorage[s])()}catch(t){e=sessionStorage[s]}return e},cmn.storageDelSS=t=>{sessionStorage.removeItem(t)},$(()=>{let c=!1;$(document).on("click",".js-comment-submit",async function(){let t=$(this),s=t.closest(".js-form-comment"),e=$('[name="comment"]',s),o=$('[name="author"]',s),a=$(".js-comment-notification",s),n=$(".js-comment-inner"),i=$(".js-comment-list");$('[name="comment_post_ID"]',s).val();var l=new FormData(s[0]),l=Object.fromEntries(l.entries());if(e.on("input",()=>{a.removeClass("caution").hide()}),!c){if(""===e.val().trim())return a.addClass("caution").html("コメントが入力されていることをご確認の上、もう一度お試しください。").show(),!1;c=!0,t.html('<span class="animation-blinker">送信中...</span>');var r,l=await(await fetch("/assets/ajax/post-comment.php",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-Token":CSRF_TOKEN},body:JSON.stringify(l)})).text();"success"===l?(a.removeClass("caution").html("コメントありがとうございます！").show(),r=`
        ...
        `,0===i.length&&(n.append('<div class="post-comment__list js-comment-list"></div>'),i=$(".js-comment-list")),0<$(".post-comment__unit",i).length?$(".post-comment__unit:first-child",i).before(r):i.append(r),e.val(""),o.val(""),console.log(ssd.post)):(console.log(l),a.addClass("caution").html("コメント送信できませんでした。恐れ入りますが、もう一度お試しください。").show()),c=!1,t.html("コメントする")}return!1})}),ssd.changePage=async(h={},u)=>{let g=$(".js-article"),_=$(".js-article-inner"),f=$(".js-loading");g.css({"min-height":g.height()}),g.animate({top:-10,opacity:0},350,async function(){f.show(),h.path||(h.path="404");var t="https://simplesimples.com"+h.path,s=h.path.replace(/^\/|\/$/g,"").split("/"),e={};let o="シンプルシンプルデザイン",a="",n="",i,l,r="",c=!1,m=!1,p=!1;switch(s[0]){case"":p=!0,o="",a="",l=await fetch("/assets/include/pages/home.php"),r=await l.text();break;case"blog":o="個人ブログは引っ越しました | "+o,a="個人ブログは別ドメインに引っ越ししました。ぜひ、引っ越し先をご覧ください。",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"service":o="サービス | "+o,a="",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"about":o="事業内容 | "+o,a="",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"contact":o="お問い合わせ | "+o,a="",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"privacy":o="プライバシーポリシー | "+o,a="",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"post":o="制作ブログ | "+o,a="",n="",l=await fetch(`/assets/include/pages/${s[0]}.php`),r=await l.text();break;case"search":var d=cmn.getParam(location.search).q;if(!d)return void ssd.changePage();d=decodeURIComponent(d),o=`制作ブログ「${d}」の検索結果 | `+o;a=`制作ブログ内で「${d}」を含む記事は、10件見つかりました。`,n="",r=s[0];break;case"web":case"video":case"overview":let t="";"web"===s[0]&&s[3]?t=s[3]:"web"!=s[0]&&s[2]&&(t=s[2]),t?(m=!0,t=decodeURIComponent(t),(post_list=ssd.getPostListInfo(t))&&(o=post_list.title,a=post_list.description,n=post_list.img,r=await ssd.getPostData(post_list.id))&&""!=r?i={id:post_list.id,html:r}:c=!0):(o="",a="",n="",r=ssd.setPostCategory(s[s.length-1]));break;default:c=!0}switch(c&&(o="表示できませんでした | "+o,a="",l=await fetch("/assets/include/pages/system.php"),r=await l.text()),$("title").html(o),$('meta[name="description"]').attr("content",a),$('meta[property="og:image"]').attr("content",n),$('link[rel="canonical"]').attr("href",t),$("body").attr("data-menu","hide").attr("data-page",s[0]||"home"),f.hide(),_.html(r),g.css({"min-height":"unset"}),$(window).scrollTop(0),g.animate({top:0,opacity:1},350),!0){case m:hljs.highlightAll(),ssd.setPostLink();break;case p:ssd.businessquotes.is_init||(ssd.businessquotes.is_init=!0,ssd.setBusinessquotes())}u&&h.path!=ssd.last_history&&(ssd.last_history=h.path,e.path=h.path,i&&(e.data=i),cmn.historyPushState(e,"",h.path)),ssd.is_delete_splash||(ssd.is_delete_splash=!0,cmn.removeSplash())})},$(()=>{let c=!1,m=t=>{$('.js-form-contact button[type="button"]').before('<p class="contact__error js-contact-error">'+t+"</p>")};$(document).on("click",'.js-form-contact button[type="button"]',async function(){let t=$(this),s=t.closest(".js-form-contact"),o=$(".js-contact-error",s),a=$(".js-contact-success",s),n=$(".js-contact-success-hide",s);if($(".js-link-contact-noreply",s).on("click",()=>(n.toggle(),!1)),!c){o.remove(),a.hide();var i=new FormData(s.get(0));let e={};if(i.forEach((t,s)=>{e[s]=t}),""===e.name.trim())return m("お名前を入力してください。"),!1;if(!/\S+@\S+\.\S+/.test(e.email))return m("メールアドレスを入力してください。"),!1;if(""===e.content.trim())return m("お問い合わせ内容を入力してください。"),!1;c=!0,t.html('<span class="animation-blinker">送信中...</span>');var i=e.email,l=`
<p>【こちらは自動返信メールです】</p>
...
<ul class="sns-list post__sns-list">
  ...
  `,i=0===t.comments.length?'<p class="post-comment__none js-comment-none">この記事の最初のコメントを書いてくれると嬉しいです！</p>':"";let r="";for(a of t.comments){let{author:t,content:s,date:e}=a;t=t.trim()||"(匿名)",s=(s=s.replace(/</g,"＜").replace(/>/g,"＞")).replace(/&lt;/g,"＜").replace(/&gt;/g,"＞"),s=cmn.getNrToBr(s),r+=`
<div class="post-comment__unit">
  <div class="post-comment__unit-inner">
    ${s}
    <div class="post-comment__unit-info">
