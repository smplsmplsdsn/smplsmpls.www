...
$search_word = $_GET['search_word'] ?? null;

if (!$search_word) {
  returnErrorResponse('invalid_request_method(search_word:' . $search_word) .')';
}

// ファイルのパスを設定
$file_path = 'https://data.simplesimples.com/api2/?class=smplsmplsdsn&filename=search&search_word=' . $search_word;
